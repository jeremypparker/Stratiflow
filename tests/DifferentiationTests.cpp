...
//     f1.SetValue([](stratifloat x, stratifloat y, stratifloat z){return exp(-(z-0.5)*(z-0.5));}, L, 1, 1);
...
//     expected.SetValue([](stratifloat x, stratifloat y, stratifloat z){return (4*(z-0.5)*(z-0.5)-2)*exp(-(z-0.5)*(z-0.5));}, L, 1, 1);
